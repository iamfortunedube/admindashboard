                ...
                echo '<script>alert("Allocation successful");</script>';
                 ...
                 $remaining_claim_amount = (int)$claimed_amount;
                    ...
                    if($remaing_don_amount > $remaining_claim_amount){
                        ...
                        $update_donation = "Update donation SET remaining_don = '".$remaining_don."',status '1'  WHERE id = ".@$donator_id.";";
                ...
                echo '
                    ...
                    <form action="" method="post">
                        ...
                        if(mysqli_num_rows($results) > 0){
                            echo '<td> <select name="claim_option" class="form-control" style="border-color: rgb(218,165,32); border-style: dashed; border-width: 2px;">';
