...
<div class="sidebar-menu">
    ...
    <li>
            <div class="userProfile">
                ...
                <li><a id="transaction" href="donors.php"><i class="fas fa-hand-paper"></i> Donors</a></li>
                <li><a id="transaction" href="claims.php"><i class="fas fa-american-sign-language-interpreting"></i> Claims</a></li>
